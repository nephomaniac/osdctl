...
```
  ...
  osdctl cluster pull-secret snapshot -C 1kfmyclusterid --reason "OHSS-1234"

  # Full validation of a specific cluster's pull secret
  osdctl cluster pull-secret snapshot -C 1kfmyclusterid --reason "OHSS-1234" --check 2abcothercluster
```
