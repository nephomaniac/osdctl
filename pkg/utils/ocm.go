...
func GetOCMConfigFromEnv() (*Config, error) {
...
>>>>>>> a7ea81e (OSD-28241: Added utils for building OCM config, and backplane connections using provided OCM connections)
*/
...
func GetOCMSdkConnBuilderFromConfig(ocmConf *ocmConfig.Config) (*sdk.ConnectionBuilder, error) {
	if ocmConf == nil {
	...
	ocmSdkConnBuilder.URL(ocmConf.URL)
	ocmSdkConnBuilder.Tokens(ocmConf.AccessToken, ocmConf.RefreshToken)
	ocmSdkConnBuilder.Client(ocmConf.ClientID, ocmConf.ClientSecret)
...
func GetOCMSdkConnBuilderFromFilePath(configFilePath string) (*sdk.ConnectionBuilder, error) {
	...
	ocmConf, err := GetOcmConfigFromFilePath(configFilePath)
	if err != nil {
		return nil, err
	}
	return GetOCMSdkConnBuilderFromConfig(ocmConf)
