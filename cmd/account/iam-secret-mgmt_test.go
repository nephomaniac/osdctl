...
// TestHiveOcmUrlValidation tests the early validation of --hive-ocm-url flag in the iam-secret-mgmt command
func TestHiveOcmUrlValidation(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// This simulates the validation that occurs in the preRunCliChecks() method
			var err error
			if tt.hiveOcmUrl != "" {
